...
<?php include('SpravkaResult1.php'); ?>
<?php session_start();?>
<?php require_once( "webassist/security_assist/helper_php.php" ); 
...
$obj = new SpravkaResult1($pdo, $from, $to, 'by_pojarna', '', '');
$pojarna  = $obj->fetchCounts();
$sum_pojarna  = $obj->sumcount($pojarna);
        ...
        <div class="panel panel-default">
          <div class="panel-body text-cnter">
            ...
            <div class="row">
                ...
                <h4 class="text-info"><?php echo "Подадени към пожарна" ?></h4>
					<p class="text-info">за периода <?php echo date('d.m.Y',strtotime($_GET['from'])) ;?> - <?php echo date('d.m.Y',strtotime($_GET['to'])) ;?></p>
                  <table class="table table-condensed">
                    <?php foreach($pojarna as $pojarna):  ?>
                        <tr>
                            <td class="text-left col-md-5">
                            	<?php echo $pojarna->pname ;?>
                            </td>
                            <td class="text-right col-md-1"><?php echo $pojarna->counts ;?></td>
                        </tr>
                    <?php endforeach ;?> 
                        <tr class="alert-info">
                            <td class="text-left col-md-5">Всичко</td>
                            <td class="text-right col-md-1"><?php echo $sum_pojarna ;?></td>
                        </tr>
                   </table>
