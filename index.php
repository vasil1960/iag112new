...
{
	$logos = new Logos($pdo);
	$logos->insertLogos('Начална страница');
	
//	$logs = $logos->returnAllLogos();
//	var_dump($logos);
}
?>
<?php 
...
//  $WA_table = "logos";
//  $WA_sessionName = "logos";
//  $WA_redirectURL = "";
//  if (function_exists("rel2abs")) $WA_redirectURL = $WA_redirectURL?rel2abs($WA_redirectURL,dirname(__FILE__)):"";
//  $WA_keepQueryString = false;
//  $WA_fieldNamesStr = "action|ip|username|name|podelenie";
//  $WA_fieldValuesStr = "Начална страница" . $WA_AB_Split . "".((isset($_SERVER["REMOTE_ADDR"]))?$_SERVER["REMOTE_ADDR"]:"")  ."" . $WA_AB_Split . "".$_SESSION['username']  ."" . $WA_AB_Split . "".$_SESSION['Name']  ." ".$_SESSION['Familia']  ."" . $WA_AB_Split . "".$_SESSION['Podelenie']  ."";
