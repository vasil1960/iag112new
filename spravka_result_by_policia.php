...
$obj = new SpravkaResult1($pdo, $from, $to, 'by_policia', '', '');
$policia  = $obj->fetchCounts();
$sum_policia  = $obj->sumcount($policia);
        ...
        <div class="panel panel-default">
          <div class="panel-body text-cnter">
            ...
            <div class="row">
                ...
                <h4 class="text-info"><?php echo "Подадени към полиция" ?></h4>
					<p class="text-info">за периода <?php echo date('d.m.Y',strtotime($_GET['from'])) ;?> - <?php echo date('d.m.Y',strtotime($_GET['to'])) ;?></p>
                  <table class="table table-condensed">
                    <?php foreach($policia as $policia):  ?>
                        <tr>
                            <td class="text-left col-md-5">
                            	<?php echo $policia->pname ;?>
                            </td>
                            <td class="text-right col-md-1"><?php echo $policia->counts ;?></td>
                        </tr>
                    <?php endforeach ;?> 
                        <tr class="alert-info">
                            <td class="text-left col-md-5">Всичко</td>
                            <td class="text-right col-md-1"><?php echo $sum_policia ;?></td>
                        </tr>
                   </table>
