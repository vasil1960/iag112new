...
if(isset($_GET['send_to_extra'])){
	$send_to_extra = $_GET['send_to_extra'];	
}
...
{
	$param = 'by_policia';
	$title = 'Сигнали към полицията за:';
}

if($send_to_extra == 2)
{
	$param = 'by_pojarna';
	$title = 'Сигнали към пожарна за:';
}

if($send_to_extra == 3)
{
	$param = 'by_babh';
	$title = 'Сигнали към БАБХ за:';
}

$obj = new SpravkaResult($pdo, $from, $to, $param, '', '');
$send_to_extra  = $obj->fetchCounts();
$sum_send_to_extra  = $obj->sumcount($send_to_extra);

//var_dump($proveren_na_mesto);
            ...
            <div class="row">
                ...
                <h4 class="text-info"><?php echo $title ?></h4>
                  ...
                  <table class="table table-condensed">
                    <?php foreach($send_to_extra as $send_to_extra):  ?>
                        <tr>
                            <td class="text-left col-md-5">
                            	<?php echo $send_to_extra->pname ;?>
                            </td>
                            <td class="text-right col-md-1"><?php echo $send_to_extra->counts ;?></td>
                        </tr>
                    <?php endforeach ;?> 
                        <tr class="alert-info">
                            <td class="text-left col-md-5">Всичко</td>
                            <td class="text-right col-md-1"><?php echo $sum_send_to_extra ;?></td>
                        </tr>
                   </table>
