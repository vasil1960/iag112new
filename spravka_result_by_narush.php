...
if(isset($_GET['type_narush'])){
	$type_narush = $_GET['type_narush'];	
}
...
$obj = new SpravkaResult($pdo, $from, $to, 'by_type_narushenia', '', $type_narush);
        ...
        <div class="panel panel-default">
          <div class="panel-body text-cnter">
            ...
            <div class="row">
                ...
                <h4 class="text-info"><?php echo $naimenovanie; ?></h4>
